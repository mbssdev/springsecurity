...
import com.springsecurity.sec07.exceptionhandling.CustomAccessDeniedHandler;
import com.springsecurity.sec07.exceptionhandling.CustomBasicAuthenticationEntryPoint;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requiresChannel(cr -> cr.anyRequest().requiresInsecure()) // only https
